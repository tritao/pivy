...
def check_enum_constant_contract() -> None:
    ...
    assert_type(coin.SoExtSelection.NOLASSO, coin.SoExtSelectionLassoType)
    assert_type(coin.SoExtSelection.PART_BBOX, coin.SoExtSelectionLassoPolicy)
    assert_type(coin.SoExtSelection.VISIBLE_SHAPES, coin.SoExtSelectionLassoMode)
