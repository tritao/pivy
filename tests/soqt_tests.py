...
class SoQtContractTests(unittest.TestCase):
    ...
    def test_lifecycle_and_metadata(self):
        ...
        self.assertTrue(self.top_level_widget.isVisible())
        self.assertIsNone(self.top_level_widget.hide())
        self.assertFalse(self.top_level_widget.isVisible())
        self.assertIsNone(self.top_level_widget.setVisible(True))
        self.assertEqual(self.top_level_widget.windowTitle(), "Pivy")
        self.assertEqual(self.top_level_widget.width(), 640)
        self.assertEqual(self.top_level_widget.height(), 480)
